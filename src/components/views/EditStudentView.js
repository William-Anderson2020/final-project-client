      ...
      <div className={classes.root}>
        <div className={classes.formContainer}>
          ...
          <form style={{textAlign: 'center'}} onSubmit={(e) => handleSubmit(e)}>
            ...
            <input type="text" name="imageURL" onChange={(e) => handleChange(e)} defaultValue={student.imageURL}/>
            <br/>
            <br/>

            <label style={{color:'#11153e', fontWeight: 'bold'}}>GPA: </label>
            <input type="number" min={0} max={4} step={.1} name="gpa" onChange={(e) => handleChange(e)} defaultValue={student.gpa} />
            <br/>
            <br/>
